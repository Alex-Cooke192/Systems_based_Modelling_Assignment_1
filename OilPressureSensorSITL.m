%% OilPressureSensorSITL.m
% Dumb SITL oil pressure sensor emulator:
% - Takes an input pressure each step()
...
classdef OilPressureSensorSITL < handle
    properties
        Fs (1,1) double = 20;
        dt (1,1) double = 1/Fs;
    ...
    methods
        function obj = OilPressureSensorSITL(varargin)
            % Name-value init
        ...
        function y = step(obj, truePkPa, tNow)
            %#ok<INUSD>
            % step() takes "truePkPa" from plant/sim and returns a raw/noisy measurement.
